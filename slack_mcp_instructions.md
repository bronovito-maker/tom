...
[`channels:write`](/reference/scopes/channels.write) for public channels, [`groups:write`](/reference/scopes/groups.write) for private channels, [`im:write`](/reference/scopes/im.write) for direct messages, [`mpim:write`](/reference/scopes/mpim.write) for multi-party DMs
...
[`channels:read`](/reference/scopes/channels.read) for public channels, [`groups:read`](/reference/scopes/groups.read) for private channels, [`mpim:read`](/reference/scopes/mpim.read) for multi-party DMs
